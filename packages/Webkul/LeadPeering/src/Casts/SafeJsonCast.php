...
namespace Webkul\LeadPeering\Casts;
 ...
 *
 * Identical to Webkul\LeadGreen\Casts\SafeJsonCast — duplicated rather than
 * shared, matching this codebase's self-contained-module convention (each
 * prospecting package owns its full stack; see crm-package-development
 * skill).
 */
