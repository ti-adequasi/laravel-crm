    ...
    'configuration' => [
        'index' => [
            ...
            'magic-ai' => [
                ...
                'settings' => [
                    'api-key' => 'API Key',
                    'api-key-info' => 'The API key for the provider selected above.',
                    'enable' => 'Enable',
                    'info' => 'Enhance your Magic AI experience by connecting an AI provider — OpenRouter, OpenAI, Anthropic, or a self-hosted Omniroute gateway. Integrate it now for a seamless, personalized AI adventure tailored just for you! Effortlessly customize settings and take control of your AI journey.',
                    'provider' => 'AI Provider',
                    'provider-info' => 'Choose which AI service Magic AI sends requests to.',
                    'providers' => [
                    ...
                    'omniroute-base-url' => 'Omniroute Base URL',
                    'omniroute-base-url-info' => 'Your self-hosted Omniroute OpenAI-compatible base URL, including /v1, e.g. http://localhost:8080/v1.',
                    'other' => 'Other Model',
                    'other-model' => 'The model to use. For OpenRouter, this overrides the preset above. For OpenAI, Anthropic, or Omniroute, this is the only place to set the model, e.g. gpt-4o-mini or claude-sonnet-4-5-20250929.',
                    ...
                    'models' => [
                        ...
                        'title' => 'Models',
                        'info' => 'These presets are OpenRouter model IDs. For OpenAI, Anthropic, or Omniroute, set the model in "Other Model" below instead.',
                    ],
                ],
            ],
        ],
