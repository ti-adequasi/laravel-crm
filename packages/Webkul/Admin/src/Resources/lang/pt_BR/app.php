    ...
    'leads' => [
        ...
        'view' => [
            ...
            'tabs' => [
                ...
                'products' => 'Produtos',
                'quotes' => 'Cotações',
                'pbx-call-history' => 'Histórico de Ligações',
            ],
            'attributes' => [
    ...
    'configuration' => [
        'index' => [
            ...
            'magic-ai' => [
                ...
                'settings' => [
                    'api-key' => 'Chave API',
                    'api-key-info' => 'A chave API do provedor selecionado acima.',
                    'enable' => 'Habilitar',
                    'info' => 'Melhore sua experiência com o Magic AI conectando um provedor de IA — OpenRouter, OpenAI, Anthropic, ou um gateway Omniroute self-hosted. Integre agora para uma aventura de IA personalizada e perfeita, feita sob medida para você! Personalize as configurações com facilidade e assuma o controle da sua jornada de IA.',
                    'provider' => 'Provedor de IA',
                    'provider-info' => 'Escolha para qual serviço de IA o Magic AI envia as requisições.',
                    'providers' => [
                        'openrouter' => 'OpenRouter (vários modelos, uma chave)',
                        'openai' => 'OpenAI',
                        'anthropic' => 'Anthropic (Claude)',
                        'omniroute' => 'Omniroute (gateway self-hosted)',
                    ],
                    'omniroute-base-url' => 'URL Base do Omniroute',
                    'omniroute-base-url-info' => 'O endereço da sua instância Omniroute self-hosted, compatível com a API da OpenAI, incluindo /v1. Ex.: http://localhost:8080/v1.',
                    'other' => 'Outro Modelo',
                    'other-model' => 'O modelo a ser usado. Para OpenRouter, isso substitui a predefinição acima. Para OpenAI, Anthropic ou Omniroute, este é o único lugar para definir o modelo — ex.: gpt-4o-mini ou claude-sonnet-4-5-20250929.',
                    ...
                    'models' => [
                        ...
                        'title' => 'Modelos',
                        'info' => 'Essas predefinições são IDs de modelo do OpenRouter. Para OpenAI, Anthropic ou Omniroute, defina o modelo em "Outro Modelo" abaixo.',
                    ],
                ],
            ],
        ],
